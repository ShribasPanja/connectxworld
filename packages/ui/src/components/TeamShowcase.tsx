      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        <div className="text-center mb-16 animate-slide-up">
          ...
          <p className="text-xl md:text-2xl text-gray-600 max-w-3xl mx-auto">
            ...
            experience across industries to deliver exceptional results.
          </p>
        </div>
            ...
            >
              <div className="relative bg-gradient-to-br from-red-600 to-red-800 rounded-2xl overflow-hidden aspect-[4/5] shadow-lg">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-6 text-white transform translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                  <h3 className="font-semibold text-lg md:text-3xl mb-1">
                    {member.name}
                  </h3>
                  <p className="text-sm md:text-xl opacity-90 mb-2">
                    {member.role}
                  </p>
                  <p className="text-xs md:text-lg opacity-75">
                    {member.expertise}
                  </p>
                </div>
              </div>
