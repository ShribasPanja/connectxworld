...
import { Search, Star, Clock, DollarSign, Users, Shield, Zap, Globe, ArrowRight, Sparkles, TrendingUp } from 'lucide-react';
...
const categories = [
  { name: 'Business Strategy', count: 45, icon: '📊', gradient: 'from-blue-500 to-indigo-600', hoverGradient: 'from-blue-600 to-indigo-700' },
  { name: 'Technology', count: 67, icon: '💻', gradient: 'from-purple-500 to-pink-600', hoverGradient: 'from-purple-600 to-pink-700' },
  { name: 'Marketing', count: 34, icon: '📈', gradient: 'from-green-500 to-emerald-600', hoverGradient: 'from-green-600 to-emerald-700' },
  { name: 'Finance', count: 28, icon: '💰', gradient: 'from-yellow-500 to-orange-600', hoverGradient: 'from-yellow-600 to-orange-700' },
  { name: 'Legal', count: 19, icon: '⚖️', gradient: 'from-gray-500 to-slate-600', hoverGradient: 'from-gray-600 to-slate-700' },
  { name: 'Healthcare', count: 23, icon: '🏥', gradient: 'from-red-500 to-rose-600', hoverGradient: 'from-red-600 to-rose-700' }
];
...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center space-x-3 group">
              <div className="relative">
                <Globe className="h-8 w-8 text-blue-600 group-hover:text-purple-600 transition-all duration-300 group-hover:rotate-12" />
            ...
            <nav className="hidden md:flex items-center space-x-8">
              <a href="#" className="text-slate-600 hover:text-transparent hover:bg-gradient-to-r hover:from-blue-600 hover:to-purple-600 hover:bg-clip-text transition-all duration-300 font-medium relative group">
                Find Experts
              ...
              <Button variant="outline" className="border-2 border-blue-200 text-blue-600 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 hover:border-purple-300 hover:text-purple-600 transition-all duration-300 hover:shadow-lg hover:shadow-blue-500/25 hover:-translate-y-0.5">
                Sign In
              </Button>
      ...
      <section className="pt-20 pb-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-slate-600 mb-12 max-w-4xl mx-auto leading-relaxed">
            Get expert advice from industry leaders. Book consultations, solve problems, 
            and accelerate your success with personalized guidance.
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {[
              { number: '1,200+', label: 'Expert Professionals', gradient: 'from-blue-500 to-cyan-500', icon: Users },
              { number: '50,000+', label: 'Consultations Completed', gradient: 'from-purple-500 to-pink-500', icon: TrendingUp },
              { number: '4.9★', label: 'Average Rating', gradient: 'from-yellow-500 to-orange-500', icon: Star }
            ].map((stat, index) => (
              <div key={index} className="group cursor-pointer">
                <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 border border-white/50 shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className={`text-4xl font-bold bg-gradient-to-r ${stat.gradient} bg-clip-text text-transparent mb-2 group-hover:scale-105 transition-transform duration-300`}>
                      {stat.number}
                    </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {categories.map((category, index) => (
              <Card key={index} className="group hover:shadow-2xl transition-all duration-500 cursor-pointer border-0 bg-white hover:-translate-y-3 relative overflow-hidden">
                ...
                <div className={`absolute inset-0 bg-gradient-to-br ${category.hoverGradient} opacity-0 group-hover:opacity-90 transition-all duration-700 delay-100`}></div>
        ...
        <div className="container mx-auto relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {professionals.map((professional, index) => (
              <Card key={professional.id} className="group hover:shadow-2xl transition-all duration-500 border-0 bg-white/90 backdrop-blur-sm hover:-translate-y-4 relative overflow-hidden">
                <div className={`absolute inset-0 bg-gradient-to-br ${professional.gradient} opacity-0 group-hover:opacity-5 transition-opacity duration-500`}></div>
                ...
                <CardHeader className="pb-4 relative z-10">
                  <div className="flex items-start space-x-4">
                    <div className="relative group-hover:scale-110 transition-transform duration-300">
                      ...
                      />
                      <div className={`absolute -inset-1 bg-gradient-to-r ${professional.gradient} rounded-full opacity-0 group-hover:opacity-50 blur transition-all duration-300`}></div>
                    </div>
                  ...
                  <div className="space-y-6">
                    <div className="flex flex-wrap gap-2">
                      {professional.expertise.map((skill, skillIndex) => (
                        <Badge key={skillIndex} className={`bg-gradient-to-r ${professional.gradient} text-white hover:scale-105 transition-transform duration-200 shadow-lg`}>
                          {skill}
                        </Badge>
                      ))}
                    </div>
                    <div className="flex items-center justify-between">
                      ...
                      <div className="flex items-center space-x-1 text-sm bg-green-50 px-3 py-2 rounded-full">
                        ...
                        <span className="text-green-700 font-medium">{professional.availability}</span>
                      </div>
                    </div>
                    <Button className={`w-full bg-gradient-to-r ${professional.gradient} hover:shadow-xl hover:-translate-y-1 transition-all duration-300 text-white font-semibold py-3 group relative overflow-hidden`}>
          ...
          <div className="text-center mt-16">
            <Button variant="outline" size="lg" className="border-2 border-blue-200 text-blue-600 hover:bg-gradient-to-r hover:from-blue-50 hover:to-purple-50 hover:border-purple-300 hover:text-purple-600 transition-all duration-300 hover:shadow-xl hover:-translate-y-1 px-8 py-4 text-lg font-semibold">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
            {[
              { 
                ...
                description: 'Browse our curated network of professionals or search by expertise, industry, or specific skills you need.',
              ...
              { 
                ...
                description: 'Schedule a consultation at your convenience. Choose from video calls, phone calls, or in-person meetings.',
              ...
              { 
                icon: Zap, 
                title: '3. Get Results', 
                description: 'Receive personalized advice, actionable insights, and expert guidance to achieve your goals faster.',
                gradient: 'from-green-500 to-emerald-500',
                delay: '400'
              }
            ].map((step, index) => (
              <div key={index} className={`text-center group hover:-translate-y-4 transition-all duration-500 delay-${step.delay}`}>
                <div className="relative mb-8">
                  <div className={`w-24 h-24 bg-gradient-to-br ${step.gradient} rounded-3xl flex items-center justify-center mx-auto shadow-2xl group-hover:shadow-3xl group-hover:scale-110 transition-all duration-500 relative overflow-hidden`}>
                  ...
                  <div className={`absolute -inset-2 bg-gradient-to-br ${step.gradient} rounded-3xl opacity-0 group-hover:opacity-20 blur-xl transition-all duration-500`}></div>
                </div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
        <div className="container mx-auto">
          <div className="bg-white/80 backdrop-blur-xl rounded-3xl p-12 md:p-16 shadow-2xl border border-white/50 relative overflow-hidden group hover:shadow-3xl transition-all duration-500">
            ...
            <div className="text-center mb-12 relative z-10">
              ...
              <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
                Your privacy and security are our top priorities. All consultations and payments 
                are protected with enterprise-grade security.
              </p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 relative z-10">
              {[
                { icon: Shield, title: 'Verified Experts', description: 'All professionals are thoroughly vetted and verified', gradient: 'from-blue-500 to-cyan-500' },
                { icon: DollarSign, title: 'Secure Payments', description: 'Bank-level encryption for all transactions', gradient: 'from-green-500 to-emerald-500' },
                { icon: Star, title: 'Quality Guarantee', description: 'Satisfaction guaranteed or your money back', gradient: 'from-purple-500 to-pink-500' }
              ].map((feature, index) => (
                <div key={index} className="text-center group/item hover:-translate-y-2 transition-all duration-300">
                  <div className={`w-16 h-16 bg-gradient-to-br ${feature.gradient} rounded-2xl flex items-center justify-center mx-auto mb-6 shadow-lg group-hover/item:shadow-xl group-hover/item:scale-110 transition-all duration-300`}>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 relative overflow-hidden">
        ...
        <div className="container mx-auto text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl text-blue-100 mb-12 max-w-3xl mx-auto leading-relaxed">
            Join thousands of successful individuals who've accelerated their growth 
            with expert guidance from ConnectXWorld.
          </p>
          <div className="flex flex-col sm:flex-row gap-6 justify-center">
            <Button size="lg" className="bg-white text-blue-600 hover:bg-blue-50 hover:text-purple-600 text-xl px-12 py-6 font-bold shadow-2xl hover:shadow-3xl hover:-translate-y-1 transition-all duration-300 group">
              Find an Expert
              <ArrowRight className="ml-3 h-6 w-6 group-hover:translate-x-1 transition-transform duration-300" />
            </Button>
            <Button size="lg" variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-blue-600 text-xl px-12 py-6 font-bold shadow-2xl hover:shadow-3xl hover:-translate-y-1 transition-all duration-300 group">
              Become an Expert
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
            <div className="group">
              ...
              <p className="text-slate-400 leading-relaxed group-hover:text-slate-300 transition-colors duration-300">
                Connecting you with world-class professionals for personalized consultations 
                and expert guidance.
              </p>
            </div>
            {[
              {
                title: 'For Clients',
                links: ['Find Experts', 'How it Works', 'Pricing', 'Success Stories']
              },
              {
                title: 'For Experts',
                links: ['Join as Expert', 'Expert Resources', 'Earning Potential', 'Expert Community']
              },
              {
                title: 'Support',
              ...
              <div key={index}>
                ...
                <ul className="space-y-3">
                  {section.links.map((link, linkIndex) => (
                    <li key={linkIndex}>
                      <a href="#" className="text-slate-400 hover:text-white hover:bg-gradient-to-r hover:from-blue-400 hover:to-purple-400 hover:bg-clip-text hover:text-transparent transition-all duration-300 relative group">
                        {link}
